...
{	
  ...
  800049:	e8 f6 1f 00 00       	call   802044 <sys_calculate_free_frames>
  80004e:	89 c3                	mov    %eax,%ebx
  800050:	e8 08 20 00 00       	call   80205d <sys_calculate_modified_frames>
...
//	sys_disable_interrupt();
  ...
  8001f8:	68 ea 28 80 00       	push   $0x8028ea
  ...
  80020b:	e8 8e 19 00 00       	call   801b9e <free>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8004f8:	68 1e 29 80 00       	push   $0x80291e
  ...
  800519:	50                   	push   %eax
  80051a:	68 20 29 80 00       	push   $0x802920
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800547:	50                   	push   %eax
  800548:	68 25 29 80 00       	push   $0x802925
...
cputchar(int ch)
{
  ...
  80056b:	50                   	push   %eax
  80056c:	e8 d7 1b 00 00       	call   802148 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  80057a:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80057d:	e8 92 1b 00 00       	call   802114 <sys_disable_interrupt>
	char c = ch;
  ...
  80058f:	50                   	push   %eax
  800590:	e8 b3 1b 00 00       	call   802148 <sys_cputc>
  800595:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800598:	e8 91 1b 00 00       	call   80212e <sys_enable_interrupt>
}
  80059d:	90                   	nop
  80059e:	c9                   	leave  
  80059f:	c3                   	ret    
...
getchar(void)
{
  ...
  8005ad:	eb 08                	jmp    8005b7 <getchar+0x17>
	{
		c = sys_cgetc();
  8005af:	e8 78 19 00 00       	call   801f2c <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8005c5:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005c8:	e8 47 1b 00 00       	call   802114 <sys_disable_interrupt>
	int c=0;
  ...
  8005d4:	eb 08                	jmp    8005de <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8005d6:	e8 51 19 00 00       	call   801f2c <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8005e2:	74 f2                	je     8005d6 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8005e4:	e8 45 1b 00 00       	call   80212e <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8005fe:	e8 76 19 00 00       	call   801f79 <sys_getenvindex>
  ...
  800678:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80067b:	e8 94 1a 00 00       	call   802114 <sys_disable_interrupt>
	cprintf("**************************************\n");
  800680:	83 ec 0c             	sub    $0xc,%esp
  800683:	68 44 29 80 00       	push   $0x802944
  ...
  8006a9:	52                   	push   %edx
  8006aa:	50                   	push   %eax
  8006ab:	68 6c 29 80 00       	push   $0x80296c
  ...
  8006d1:	52                   	push   %edx
  8006d2:	50                   	push   %eax
  8006d3:	68 94 29 80 00       	push   $0x802994
  ...
  8006ee:	50                   	push   %eax
  8006ef:	68 d5 29 80 00       	push   $0x8029d5
  8006f4:	e8 e6 02 00 00       	call   8009df <cprintf>
  8006f9:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8006fc:	83 ec 0c             	sub    $0xc,%esp
  8006ff:	68 44 29 80 00       	push   $0x802944
  800704:	e8 d6 02 00 00       	call   8009df <cprintf>
  800709:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80070c:	e8 1d 1a 00 00       	call   80212e <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800724:	e8 1c 18 00 00       	call   801f45 <sys_env_destroy>
...
exit(void)
{
  ...
  800732:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800735:	e8 71 18 00 00       	call   801fab <sys_env_exit>
}
  80073a:	90                   	nop
  80073b:	c9                   	leave  
  80073c:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80075d:	50                   	push   %eax
  80075e:	68 ec 29 80 00       	push   $0x8029ec
  ...
  800776:	50                   	push   %eax
  800777:	68 f1 29 80 00       	push   $0x8029f1
  ...
  80079b:	68 0d 2a 80 00       	push   $0x802a0d
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8007c7:	68 10 2a 80 00       	push   $0x802a10
  8007cc:	6a 26                	push   $0x26
  8007ce:	68 5c 2a 80 00       	push   $0x802a5c
  ...
  80088d:	68 68 2a 80 00       	push   $0x802a68
  800892:	6a 3a                	push   $0x3a
  800894:	68 5c 2a 80 00       	push   $0x802a5c
  ...
  8008f7:	68 bc 2a 80 00       	push   $0x802abc
  8008fc:	6a 44                	push   $0x44
  8008fe:	68 5c 2a 80 00       	push   $0x802a5c
...
static void putch(int ch, struct printbuf *b) {
  ...
  80094f:	51                   	push   %ecx
  800950:	52                   	push   %edx
  800951:	e8 ad 15 00 00       	call   801f03 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8009c7:	50                   	push   %eax
  8009c8:	e8 36 15 00 00       	call   801f03 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800a0f:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800a12:	e8 fd 16 00 00       	call   802114 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a2f:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a32:	e8 f7 16 00 00       	call   80212e <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800a7c:	e8 b7 1a 00 00       	call   802538 <__udivdi3>
  ...
  800aca:	52                   	push   %edx
  800acb:	50                   	push   %eax
  800acc:	e8 77 1b 00 00       	call   802648 <__umoddi3>
  800ad1:	83 c4 10             	add    $0x10,%esp
  800ad4:	05 34 2d 80 00       	add    $0x802d34,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800c27:	8b 04 85 58 2d 80 00 	mov    0x802d58(,%eax,4),%eax
  ...
  800d08:	8b 34 9d a0 2b 80 00 	mov    0x802ba0(,%ebx,4),%esi
  800d0f:	85 f6                	test   %esi,%esi
  800d11:	75 19                	jne    800d2c <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800d13:	53                   	push   %ebx
  800d14:	68 45 2d 80 00       	push   $0x802d45
  ...
  800d27:	e9 49 02 00 00       	jmp    800f75 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800d2c:	56                   	push   %esi
  800d2d:	68 4e 2d 80 00       	push   $0x802d4e
  ...
  800d58:	75 05                	jne    800d5f <vprintfmt+0x1a6>
				p = "(null)";
  800d5a:	be 51 2d 80 00       	mov    $0x802d51,%esi
			if (width > 0 && padc != '-')
...
void readline(const char *prompt, char* buf)
{
  ...
  801073:	68 b0 2e 80 00       	push   $0x802eb0
  ...
  8010b5:	68 b3 2e 80 00       	push   $0x802eb3
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801162:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801165:	e8 aa 0f 00 00       	call   802114 <sys_disable_interrupt>
	int i, c, echoing;
  ...
  801176:	68 b0 2e 80 00       	push   $0x802eb0
  ...
  8011b4:	68 b3 2e 80 00       	push   $0x802eb3
  8011b9:	e8 21 f8 ff ff       	call   8009df <cprintf>
  8011be:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  8011c1:	e8 68 0f 00 00       	call   80212e <sys_enable_interrupt>
			return;
  ...
  801256:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  801259:	e8 d0 0e 00 00       	call   80212e <sys_enable_interrupt>
			return;
...
void* malloc(uint32 size)
{
  ...
  80197c:	75 33                	jne    8019b1 <malloc+0x42>
	{
		spaces[0].str_address = (void*)USER_HEAP_START;
  80197e:	c7 05 20 31 80 00 00 	movl   $0x80000000,0x803120
  801985:	00 00 80 
		spaces[0].end_address = (void*)USER_HEAP_MAX;
  801988:	c7 05 24 31 80 00 00 	movl   $0xa0000000,0x803124
  80198f:	00 00 a0 
		spaces[0].pages = numPages;
  801992:	c7 05 28 31 80 00 00 	movl   $0x20000,0x803128
  801999:	00 02 00 
		spaces[0].isFree = 1;
  80199c:	c7 05 2c 31 80 00 01 	movl   $0x1,0x80312c
  8019a3:	00 00 00 
		arraySize++;
  8019a6:	a1 2c 30 80 00       	mov    0x80302c,%eax
  8019ab:	40                   	inc    %eax
  8019ac:	a3 2c 30 80 00       	mov    %eax,0x80302c
	}
	int min_diff = numPages + 1;
  8019b1:	c7 45 f4 01 00 02 00 	movl   $0x20001,-0xc(%ebp)
	int index = -1;
  8019b8:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
	size = ROUNDUP(size,PAGE_SIZE);
  8019bf:	c7 45 e8 00 10 00 00 	movl   $0x1000,-0x18(%ebp)
  ...
  801a53:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801a56:	7c 9f                	jl     8019f7 <malloc+0x88>
			}
		}
	...
	if(index == -1 )
  801a58:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
  801a5c:	75 0a                	jne    801a68 <malloc+0xf9>
	{
		return NULL;
  801a5e:	b8 00 00 00 00       	mov    $0x0,%eax
  801a63:	e9 34 01 00 00       	jmp    801b9c <malloc+0x22d>
	}
  ...
  801a96:	c1 e0 04             	shl    $0x4,%eax
  801a99:	05 20 31 80 00       	add    $0x803120,%eax
  801a9e:	8b 00                	mov    (%eax),%eax
  801aa0:	83 ec 08             	sub    $0x8,%esp
  801aa3:	52                   	push   %edx
  801aa4:	50                   	push   %eax
  801aa5:	e8 01 06 00 00       	call   8020ab <sys_allocateMem>
  801aaa:	83 c4 10             	add    $0x10,%esp
  801aad:	e9 dd 00 00 00       	jmp    801b8f <malloc+0x220>
		}
		else
		{
			void* newEnd = spaces[index].str_address + (reqPages*PAGE_SIZE);
  801ab2:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ab5:	c1 e0 04             	shl    $0x4,%eax
  801ab8:	05 20 31 80 00       	add    $0x803120,%eax
  801abd:	8b 00                	mov    (%eax),%eax
  801abf:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801ac2:	c1 e2 0c             	shl    $0xc,%edx
  801ac5:	01 d0                	add    %edx,%eax
  801ac7:	89 45 dc             	mov    %eax,-0x24(%ebp)
			//add new free space after allocation of new size
			spaces[arraySize].str_address = newEnd;
  801aca:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801acf:	c1 e0 04             	shl    $0x4,%eax
  801ad2:	8d 90 20 31 80 00    	lea    0x803120(%eax),%edx
  801ad8:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801adb:	89 02                	mov    %eax,(%edx)
			spaces[arraySize].end_address = spaces[index].end_address;
  801add:	8b 15 2c 30 80 00    	mov    0x80302c,%edx
  801ae3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801ae6:	c1 e0 04             	shl    $0x4,%eax
  801ae9:	05 24 31 80 00       	add    $0x803124,%eax
  801aee:	8b 00                	mov    (%eax),%eax
  801af0:	c1 e2 04             	shl    $0x4,%edx
  801af3:	81 c2 24 31 80 00    	add    $0x803124,%edx
  801af9:	89 02                	mov    %eax,(%edx)
			spaces[arraySize].pages = spaces[index].pages-reqPages;
  801afb:	8b 15 2c 30 80 00    	mov    0x80302c,%edx
  ...
  801b0e:	2b 45 e0             	sub    -0x20(%ebp),%eax
  801b11:	c1 e2 04             	shl    $0x4,%edx
  801b14:	81 c2 28 31 80 00    	add    $0x803128,%edx
  801b1a:	89 02                	mov    %eax,(%edx)
			spaces[arraySize].isFree = 1;
  801b1c:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801b21:	c1 e0 04             	shl    $0x4,%eax
  801b24:	05 2c 31 80 00       	add    $0x80312c,%eax
  801b29:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
			arraySize++;
  801b2f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801b34:	40                   	inc    %eax
  801b35:	a3 2c 30 80 00       	mov    %eax,0x80302c

			//modify space to represent allocated part
			spaces[index].end_address = newEnd;
  801b3a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b3d:	c1 e0 04             	shl    $0x4,%eax
  801b40:	8d 90 24 31 80 00    	lea    0x803124(%eax),%edx
  801b46:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b49:	89 02                	mov    %eax,(%edx)
			spaces[index].pages = reqPages;
  801b4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b4e:	c1 e0 04             	shl    $0x4,%eax
  801b51:	8d 90 28 31 80 00    	lea    0x803128(%eax),%edx
  801b57:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801b5a:	89 02                	mov    %eax,(%edx)
			spaces[index].isFree = 0;
  801b5c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b5f:	c1 e0 04             	shl    $0x4,%eax
  801b62:	05 2c 31 80 00       	add    $0x80312c,%eax
  801b67:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			sys_allocateMem((uint32)spaces[index].str_address, reqPages*PAGE_SIZE);
  801b6d:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801b70:	c1 e0 0c             	shl    $0xc,%eax
  801b73:	89 c2                	mov    %eax,%edx
  801b75:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b78:	c1 e0 04             	shl    $0x4,%eax
  801b7b:	05 20 31 80 00       	add    $0x803120,%eax
  801b80:	8b 00                	mov    (%eax),%eax
  801b82:	83 ec 08             	sub    $0x8,%esp
  801b85:	52                   	push   %edx
  801b86:	50                   	push   %eax
  801b87:	e8 1f 05 00 00       	call   8020ab <sys_allocateMem>
  801b8c:	83 c4 10             	add    $0x10,%esp
		}
		return spaces[index].str_address;
  801b8f:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b92:	c1 e0 04             	shl    $0x4,%eax
  801b95:	05 20 31 80 00       	add    $0x803120,%eax
...
void free(void* virtual_address)
{
  ...
  801ba1:	83 ec 28             	sub    $0x28,%esp
	...
	int index = -1 ;
  801ba4:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
	int noMerge = 1;
  801bab:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
	for(int i = 0 ; i < arraySize ; i++)
  801bb2:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801bb9:	eb 3f                	jmp    801bfa <free+0x5c>
	{
		if(spaces[i].str_address == virtual_address)
  801bbb:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801bbe:	c1 e0 04             	shl    $0x4,%eax
  801bc1:	05 20 31 80 00       	add    $0x803120,%eax
  801bc6:	8b 00                	mov    (%eax),%eax
  801bc8:	3b 45 08             	cmp    0x8(%ebp),%eax
  801bcb:	75 2a                	jne    801bf7 <free+0x59>
		{
			index=i;
  ...
  801bf5:	eb 0d                	jmp    801c04 <free+0x66>
	...
	int noMerge = 1;
	for(int i = 0 ; i < arraySize ; i++)
  801bf7:	ff 45 ec             	incl   -0x14(%ebp)
  801bfa:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801bff:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801c02:	7c b7                	jl     801bbb <free+0x1d>
			break;
		}
	...
	if(index == -1)
  801c04:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
  801c08:	75 17                	jne    801c21 <free+0x83>
	{
		panic("Error");
  801c0a:	83 ec 04             	sub    $0x4,%esp
  801c0d:	68 c4 2e 80 00       	push   $0x802ec4
  801c12:	68 81 00 00 00       	push   $0x81
  801c17:	68 ca 2e 80 00       	push   $0x802eca
  801c1c:	e8 1c eb ff ff       	call   80073d <_panic>
	}

	for(int i = 0 ; i < arraySize ; i++)
  801c21:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801c28:	e9 cc 00 00 00       	jmp    801cf9 <free+0x15b>
	{
		if(spaces[i].isFree == 0) continue;
  801c2d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c30:	c1 e0 04             	shl    $0x4,%eax
  801c33:	05 2c 31 80 00       	add    $0x80312c,%eax
  801c38:	8b 00                	mov    (%eax),%eax
  801c3a:	85 c0                	test   %eax,%eax
  801c3c:	0f 84 b3 00 00 00    	je     801cf5 <free+0x157>

		if(spaces[index].str_address == spaces[i].end_address)
  801c42:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c45:	c1 e0 04             	shl    $0x4,%eax
  801c48:	05 20 31 80 00       	add    $0x803120,%eax
  801c4d:	8b 10                	mov    (%eax),%edx
  801c4f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c52:	c1 e0 04             	shl    $0x4,%eax
  801c55:	05 24 31 80 00       	add    $0x803124,%eax
  801c5a:	8b 00                	mov    (%eax),%eax
  801c5c:	39 c2                	cmp    %eax,%edx
  801c5e:	0f 85 92 00 00 00    	jne    801cf6 <free+0x158>
		{
			//merge
			spaces[i].end_address = spaces[index].end_address;
  801c64:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c67:	c1 e0 04             	shl    $0x4,%eax
  801c6a:	05 24 31 80 00       	add    $0x803124,%eax
  801c6f:	8b 00                	mov    (%eax),%eax
  801c71:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801c74:	c1 e2 04             	shl    $0x4,%edx
  801c77:	81 c2 24 31 80 00    	add    $0x803124,%edx
  801c7d:	89 02                	mov    %eax,(%edx)
			spaces[i].pages += spaces[index].pages;
  801c7f:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c82:	c1 e0 04             	shl    $0x4,%eax
  801c85:	05 28 31 80 00       	add    $0x803128,%eax
  801c8a:	8b 10                	mov    (%eax),%edx
  801c8c:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801c8f:	c1 e0 04             	shl    $0x4,%eax
  801c92:	05 28 31 80 00       	add    $0x803128,%eax
  801c97:	8b 00                	mov    (%eax),%eax
  801c99:	01 c2                	add    %eax,%edx
  801c9b:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c9e:	c1 e0 04             	shl    $0x4,%eax
  801ca1:	05 28 31 80 00       	add    $0x803128,%eax
  ...
  801cae:	05 20 31 80 00       	add    $0x803120,%eax
  801cb3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].end_address = 0;
  801cb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801cbc:	c1 e0 04             	shl    $0x4,%eax
  801cbf:	05 24 31 80 00       	add    $0x803124,%eax
  801cc4:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].pages = -1;
  801cca:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ccd:	c1 e0 04             	shl    $0x4,%eax
  801cd0:	05 28 31 80 00       	add    $0x803128,%eax
  801cd5:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
			spaces[index].isFree = 0;
  801cdb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801cde:	c1 e0 04             	shl    $0x4,%eax
  801ce1:	05 2c 31 80 00       	add    $0x80312c,%eax
  801ce6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			noMerge = 0;
  801cec:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
			break;
  801cf3:	eb 12                	jmp    801d07 <free+0x169>
		panic("Error");
	}
  ...
  801cf5:	90                   	nop
	...
	for(int i = 0 ; i < arraySize ; i++)
  801cf6:	ff 45 e8             	incl   -0x18(%ebp)
  801cf9:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801cfe:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  801d01:	0f 8c 26 ff ff ff    	jl     801c2d <free+0x8f>
			noMerge = 0;
			break;
		}
	}
  ...
  801d0e:	e9 cc 00 00 00       	jmp    801ddf <free+0x241>
	{
		if(spaces[i].isFree == 0) continue;
  801d13:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d16:	c1 e0 04             	shl    $0x4,%eax
  801d19:	05 2c 31 80 00       	add    $0x80312c,%eax
  801d1e:	8b 00                	mov    (%eax),%eax
  801d20:	85 c0                	test   %eax,%eax
  801d22:	0f 84 b3 00 00 00    	je     801ddb <free+0x23d>

		if(spaces[index].end_address == spaces[i].str_address)
  801d28:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d2b:	c1 e0 04             	shl    $0x4,%eax
  801d2e:	05 24 31 80 00       	add    $0x803124,%eax
  801d33:	8b 10                	mov    (%eax),%edx
  801d35:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d38:	c1 e0 04             	shl    $0x4,%eax
  801d3b:	05 20 31 80 00       	add    $0x803120,%eax
  801d40:	8b 00                	mov    (%eax),%eax
  801d42:	39 c2                	cmp    %eax,%edx
  801d44:	0f 85 92 00 00 00    	jne    801ddc <free+0x23e>
		{
			//merge
			spaces[i].str_address = spaces[index].str_address;
  801d4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d4d:	c1 e0 04             	shl    $0x4,%eax
  801d50:	05 20 31 80 00       	add    $0x803120,%eax
  801d55:	8b 00                	mov    (%eax),%eax
  801d57:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801d5a:	c1 e2 04             	shl    $0x4,%edx
  801d5d:	81 c2 20 31 80 00    	add    $0x803120,%edx
  801d63:	89 02                	mov    %eax,(%edx)
			spaces[i].pages += spaces[index].pages;
  801d65:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d68:	c1 e0 04             	shl    $0x4,%eax
  801d6b:	05 28 31 80 00       	add    $0x803128,%eax
  801d70:	8b 10                	mov    (%eax),%edx
  ...
  801d87:	05 28 31 80 00       	add    $0x803128,%eax
  ...
  801d94:	05 20 31 80 00       	add    $0x803120,%eax
  801d99:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].end_address = 0;
  801d9f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801da2:	c1 e0 04             	shl    $0x4,%eax
  801da5:	05 24 31 80 00       	add    $0x803124,%eax
  801daa:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].pages = -1;
  801db0:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801db3:	c1 e0 04             	shl    $0x4,%eax
  801db6:	05 28 31 80 00       	add    $0x803128,%eax
  801dbb:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
			spaces[index].isFree = 0;
  801dc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801dc4:	c1 e0 04             	shl    $0x4,%eax
  801dc7:	05 2c 31 80 00       	add    $0x80312c,%eax
  801dcc:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			noMerge = 0;
  801dd2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
			break;
  801dd9:	eb 12                	jmp    801ded <free+0x24f>
		}
	}
  ...
  801de7:	0f 8c 26 ff ff ff    	jl     801d13 <free+0x175>
			noMerge = 0;
			break;
		}
	}
	...
	if(noMerge == 1)
  801ded:	83 7d f0 01          	cmpl   $0x1,-0x10(%ebp)
  801df1:	75 11                	jne    801e04 <free+0x266>
	{
		spaces[index].isFree = 1;
  801df3:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801df6:	c1 e0 04             	shl    $0x4,%eax
  801df9:	05 2c 31 80 00       	add    $0x80312c,%eax
  801dfe:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
	}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801e10:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801e13:	83 ec 04             	sub    $0x4,%esp
  801e16:	68 d8 2e 80 00       	push   $0x802ed8
  801e1b:	68 b9 00 00 00       	push   $0xb9
  801e20:	68 ca 2e 80 00       	push   $0x802eca
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801e33:	68 d8 2e 80 00       	push   $0x802ed8
  801e38:	68 bf 00 00 00       	push   $0xbf
  801e3d:	68 ca 2e 80 00       	push   $0x802eca
...
void sfree(void* virtual_address)
{
  ...
  801e50:	68 d8 2e 80 00       	push   $0x802ed8
  801e55:	68 c5 00 00 00       	push   $0xc5
  801e5a:	68 ca 2e 80 00       	push   $0x802eca
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801e6d:	68 d8 2e 80 00       	push   $0x802ed8
  801e72:	68 ca 00 00 00       	push   $0xca
  801e77:	68 ca 2e 80 00       	push   $0x802eca
  801e7c:	e8 bc e8 ff ff       	call   80073d <_panic>
...
void expand(uint32 newSize)
{
  ...
  801e8a:	68 d8 2e 80 00       	push   $0x802ed8
  801e8f:	68 d0 00 00 00       	push   $0xd0
  801e94:	68 ca 2e 80 00       	push   $0x802eca
  801e99:	e8 9f e8 ff ff       	call   80073d <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801ea7:	68 d8 2e 80 00       	push   $0x802ed8
  801eac:	68 d4 00 00 00       	push   $0xd4
  801eb1:	68 ca 2e 80 00       	push   $0x802eca
  801eb6:	e8 82 e8 ff ff       	call   80073d <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801ec4:	68 d8 2e 80 00       	push   $0x802ed8
  801ec9:	68 d9 00 00 00       	push   $0xd9
  801ece:	68 ca 2e 80 00       	push   $0x802eca
  801ed3:	e8 65 e8 ff ff       	call   80073d <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801eed:	8b 7d 18             	mov    0x18(%ebp),%edi
  801ef0:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801f0f:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  801f21:	e8 b2 ff ff ff       	call   801ed8 <syscall>
...
sys_cgetc(void)
{
  ...
  801f3b:	e8 98 ff ff ff       	call   801ed8 <syscall>
  801f40:	83 c4 18             	add    $0x18,%esp
}
  801f43:	c9                   	leave  
  801f44:	c3                   	ret    

00801f45 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801f53:	50                   	push   %eax
  801f54:	6a 05                	push   $0x5
  801f56:	e8 7d ff ff ff       	call   801ed8 <syscall>
  801f5b:	83 c4 18             	add    $0x18,%esp
}
  801f5e:	c9                   	leave  
  801f5f:	c3                   	ret    

00801f60 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801f6d:	6a 02                	push   $0x2
  801f6f:	e8 64 ff ff ff       	call   801ed8 <syscall>
  801f74:	83 c4 18             	add    $0x18,%esp
}
  801f77:	c9                   	leave  
  801f78:	c3                   	ret    

00801f79 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801f86:	6a 03                	push   $0x3
  801f88:	e8 4b ff ff ff       	call   801ed8 <syscall>
  801f8d:	83 c4 18             	add    $0x18,%esp
}
  801f90:	c9                   	leave  
  801f91:	c3                   	ret    

00801f92 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801f9f:	6a 04                	push   $0x4
  801fa1:	e8 32 ff ff ff       	call   801ed8 <syscall>
  801fa6:	83 c4 18             	add    $0x18,%esp
}
  801fa9:	c9                   	leave  
  801faa:	c3                   	ret    

00801fab <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801fb8:	6a 06                	push   $0x6
  801fba:	e8 19 ff ff ff       	call   801ed8 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801fd8:	e8 fb fe ff ff       	call   801ed8 <syscall>
  801fdd:	83 c4 18             	add    $0x18,%esp
}
  801fe0:	c9                   	leave  
  801fe1:	c3                   	ret    

00801fe2 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801fe7:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801ff9:	52                   	push   %edx
  801ffa:	50                   	push   %eax
  801ffb:	6a 08                	push   $0x8
  801ffd:	e8 d6 fe ff ff       	call   801ed8 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  80201b:	52                   	push   %edx
  80201c:	50                   	push   %eax
  80201d:	6a 09                	push   $0x9
  80201f:	e8 b4 fe ff ff       	call   801ed8 <syscall>
  802024:	83 c4 18             	add    $0x18,%esp
}
  802027:	c9                   	leave  
  802028:	c3                   	ret    

00802029 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  802038:	6a 0a                	push   $0xa
  80203a:	e8 99 fe ff ff       	call   801ed8 <syscall>
  80203f:	83 c4 18             	add    $0x18,%esp
}
  802042:	c9                   	leave  
  802043:	c3                   	ret    

00802044 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  802051:	6a 0b                	push   $0xb
  802053:	e8 80 fe ff ff       	call   801ed8 <syscall>
  802058:	83 c4 18             	add    $0x18,%esp
}
  80205b:	c9                   	leave  
  80205c:	c3                   	ret    

0080205d <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  80206a:	6a 0c                	push   $0xc
  80206c:	e8 67 fe ff ff       	call   801ed8 <syscall>
  802071:	83 c4 18             	add    $0x18,%esp
}
  802074:	c9                   	leave  
  802075:	c3                   	ret    

00802076 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  802083:	6a 0d                	push   $0xd
  802085:	e8 4e fe ff ff       	call   801ed8 <syscall>
  80208a:	83 c4 18             	add    $0x18,%esp
}
  80208d:	c9                   	leave  
  80208e:	c3                   	ret    

0080208f <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  80209e:	6a 11                	push   $0x11
  8020a0:	e8 33 fe ff ff       	call   801ed8 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  8020ba:	6a 12                	push   $0x12
  8020bc:	e8 17 fe ff ff       	call   801ed8 <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  8020d4:	6a 0e                	push   $0xe
  8020d6:	e8 fd fd ff ff       	call   801ed8 <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  8020ee:	6a 0f                	push   $0xf
  8020f0:	e8 e3 fd ff ff       	call   801ed8 <syscall>
...
void sys_scarce_memory()
{
  ...
  802109:	e8 ca fd ff ff       	call   801ed8 <syscall>
...
00802114 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  802123:	e8 b0 fd ff ff       	call   801ed8 <syscall>
...
sys_enable_interrupt()
{
  ...
  80213b:	6a 15                	push   $0x15
  80213d:	e8 96 fd ff ff       	call   801ed8 <syscall>
...
sys_cputc(const char c)
{
  ...
  802154:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  802158:	6a 00                	push   $0x0
  80215a:	6a 00                	push   $0x0
  80215c:	6a 00                	push   $0x0
  80215e:	6a 00                	push   $0x0
  802160:	50                   	push   %eax
  802161:	6a 16                	push   $0x16
  802163:	e8 70 fd ff ff       	call   801ed8 <syscall>
...
sys_clear_ffl()
{
  ...
  80217b:	6a 17                	push   $0x17
  80217d:	e8 56 fd ff ff       	call   801ed8 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  802197:	50                   	push   %eax
  802198:	6a 18                	push   $0x18
  80219a:	e8 39 fd ff ff       	call   801ed8 <syscall>
  80219f:	83 c4 18             	add    $0x18,%esp
}
  8021a2:	c9                   	leave  
  8021a3:	c3                   	ret    

008021a4 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8021b3:	52                   	push   %edx
  8021b4:	50                   	push   %eax
  8021b5:	6a 1b                	push   $0x1b
  8021b7:	e8 1c fd ff ff       	call   801ed8 <syscall>
  8021bc:	83 c4 18             	add    $0x18,%esp
}
  8021bf:	c9                   	leave  
  8021c0:	c3                   	ret    

008021c1 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8021d4:	e8 ff fc ff ff       	call   801ed8 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8021ee:	52                   	push   %edx
  8021ef:	50                   	push   %eax
  8021f0:	6a 1a                	push   $0x1a
  8021f2:	e8 e1 fc ff ff       	call   801ed8 <syscall>
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  80221a:	50                   	push   %eax
  80221b:	6a 1c                	push   $0x1c
  80221d:	e8 b6 fc ff ff       	call   801ed8 <syscall>
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  802236:	52                   	push   %edx
  802237:	50                   	push   %eax
  802238:	6a 1d                	push   $0x1d
  80223a:	e8 99 fc ff ff       	call   801ed8 <syscall>
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  802255:	52                   	push   %edx
  802256:	50                   	push   %eax
  802257:	6a 1e                	push   $0x1e
  802259:	e8 7a fc ff ff       	call   801ed8 <syscall>
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  802272:	52                   	push   %edx
  802273:	50                   	push   %eax
  802274:	6a 1f                	push   $0x1f
  802276:	e8 5d fc ff ff       	call   801ed8 <syscall>
  80227b:	83 c4 18             	add    $0x18,%esp
}
  80227e:	c9                   	leave  
  80227f:	c3                   	ret    

00802280 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  80228d:	6a 20                	push   $0x20
  80228f:	e8 44 fc ff ff       	call   801ed8 <syscall>
  802294:	83 c4 18             	add    $0x18,%esp
}
  802297:	c9                   	leave  
  802298:	c3                   	ret    

00802299 <sys_create_env>:
...
sys_run_env(int32 envId)
{
  ...
  8022c5:	50                   	push   %eax
  8022c6:	6a 22                	push   $0x22
  8022c8:	e8 0b fc ff ff       	call   801ed8 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8022e1:	50                   	push   %eax
  8022e2:	6a 23                	push   $0x23
  8022e4:	e8 ef fb ff ff       	call   801ed8 <syscall>
...
sys_get_virtual_time()
{
  ...
  8022f8:	8d 50 04             	lea    0x4(%eax),%edx
  8022fb:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8022fe:	6a 00                	push   $0x0
  802300:	6a 00                	push   $0x0
  802302:	6a 00                	push   $0x0
  802304:	52                   	push   %edx
  802305:	50                   	push   %eax
  802306:	6a 24                	push   $0x24
  802308:	e8 cb fb ff ff       	call   801ed8 <syscall>
  80230d:	83 c4 18             	add    $0x18,%esp
	return result;
  802310:	8b 4d 08             	mov    0x8(%ebp),%ecx
  802313:	8b 45 f8             	mov    -0x8(%ebp),%eax
  802316:	8b 55 fc             	mov    -0x4(%ebp),%edx
  802319:	89 01                	mov    %eax,(%ecx)
  80231b:	89 51 04             	mov    %edx,0x4(%ecx)
}
  80231e:	8b 45 08             	mov    0x8(%ebp),%eax
  802321:	c9                   	leave  
  802322:	c2 04 00             	ret    $0x4

00802325 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  80232c:	ff 75 10             	pushl  0x10(%ebp)
  80232f:	ff 75 0c             	pushl  0xc(%ebp)
  802332:	ff 75 08             	pushl  0x8(%ebp)
  802335:	6a 13                	push   $0x13
  802337:	e8 9c fb ff ff       	call   801ed8 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80234f:	6a 25                	push   $0x25
  802351:	e8 82 fb ff ff       	call   801ed8 <syscall>
  802356:	83 c4 18             	add    $0x18,%esp
}
  802359:	c9                   	leave  
  80235a:	c3                   	ret    

0080235b <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  802367:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  802376:	e8 5d fb ff ff       	call   801ed8 <syscall>
...
void rsttst()
{
  ...
  80238e:	6a 28                	push   $0x28
  802390:	e8 43 fb ff ff       	call   801ed8 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8023a7:	8b 55 18             	mov    0x18(%ebp),%edx
  8023aa:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  8023ae:	52                   	push   %edx
  8023af:	50                   	push   %eax
  8023b0:	ff 75 10             	pushl  0x10(%ebp)
  8023b3:	ff 75 0c             	pushl  0xc(%ebp)
  8023b6:	ff 75 08             	pushl  0x8(%ebp)
  8023b9:	6a 27                	push   $0x27
  8023bb:	e8 18 fb ff ff       	call   801ed8 <syscall>
...
void chktst(uint32 n)
{
  ...
  8023d4:	6a 29                	push   $0x29
  8023d6:	e8 fd fa ff ff       	call   801ed8 <syscall>
...
void inctst()
{
  ...
  8023ee:	6a 2a                	push   $0x2a
  8023f0:	e8 e3 fa ff ff       	call   801ed8 <syscall>
...
uint32 gettst()
{
  ...
  802408:	6a 2b                	push   $0x2b
  80240a:	e8 c9 fa ff ff       	call   801ed8 <syscall>
  80240f:	83 c4 18             	add    $0x18,%esp
}
  802412:	c9                   	leave  
  802413:	c3                   	ret    

00802414 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  802426:	e8 ad fa ff ff       	call   801ed8 <syscall>
  80242b:	83 c4 18             	add    $0x18,%esp
  80242e:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  802431:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  802435:	75 07                	jne    80243e <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  802437:	b8 01 00 00 00       	mov    $0x1,%eax
  80243c:	eb 05                	jmp    802443 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00802445 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802455:	6a 2c                	push   $0x2c
  802457:	e8 7c fa ff ff       	call   801ed8 <syscall>
  80245c:	83 c4 18             	add    $0x18,%esp
  80245f:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802462:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802466:	75 07                	jne    80246f <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802468:	b8 01 00 00 00       	mov    $0x1,%eax
  80246d:	eb 05                	jmp    802474 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00802476 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802486:	6a 2c                	push   $0x2c
  802488:	e8 4b fa ff ff       	call   801ed8 <syscall>
  80248d:	83 c4 18             	add    $0x18,%esp
  802490:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  802493:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  802497:	75 07                	jne    8024a0 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  802499:	b8 01 00 00 00       	mov    $0x1,%eax
  80249e:	eb 05                	jmp    8024a5 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
008024a7 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8024b9:	e8 1a fa ff ff       	call   801ed8 <syscall>
  8024be:	83 c4 18             	add    $0x18,%esp
  8024c1:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  8024c4:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  8024c8:	75 07                	jne    8024d1 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  8024ca:	b8 01 00 00 00       	mov    $0x1,%eax
  8024cf:	eb 05                	jmp    8024d6 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
008024d8 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8024e6:	6a 2d                	push   $0x2d
  8024e8:	e8 eb f9 ff ff       	call   801ed8 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8024f7:	8b 5d 14             	mov    0x14(%ebp),%ebx
  8024fa:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  802507:	52                   	push   %edx
  802508:	50                   	push   %eax
  802509:	6a 2e                	push   $0x2e
  80250b:	e8 c8 f9 ff ff       	call   801ed8 <syscall>
...
00802518 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  80252b:	e8 a8 f9 ff ff       	call   801ed8 <syscall>
...
00802538 <__udivdi3>:
  ...
  80253f:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  802543:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  802547:	8b 7c 24 38          	mov    0x38(%esp),%edi
  80254b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80254f:	89 ca                	mov    %ecx,%edx
  802551:	89 f8                	mov    %edi,%eax
  802553:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  802557:	85 f6                	test   %esi,%esi
  802559:	75 2d                	jne    802588 <__udivdi3+0x50>
  80255b:	39 cf                	cmp    %ecx,%edi
  80255d:	77 65                	ja     8025c4 <__udivdi3+0x8c>
  80255f:	89 fd                	mov    %edi,%ebp
  802561:	85 ff                	test   %edi,%edi
  802563:	75 0b                	jne    802570 <__udivdi3+0x38>
  802565:	b8 01 00 00 00       	mov    $0x1,%eax
  80256a:	31 d2                	xor    %edx,%edx
  80256c:	f7 f7                	div    %edi
  80256e:	89 c5                	mov    %eax,%ebp
  802570:	31 d2                	xor    %edx,%edx
  802572:	89 c8                	mov    %ecx,%eax
  802574:	f7 f5                	div    %ebp
  802576:	89 c1                	mov    %eax,%ecx
  802578:	89 d8                	mov    %ebx,%eax
  80257a:	f7 f5                	div    %ebp
  80257c:	89 cf                	mov    %ecx,%edi
  ...
  80258a:	77 28                	ja     8025b4 <__udivdi3+0x7c>
  80258c:	0f bd fe             	bsr    %esi,%edi
  80258f:	83 f7 1f             	xor    $0x1f,%edi
  802592:	75 40                	jne    8025d4 <__udivdi3+0x9c>
  802594:	39 ce                	cmp    %ecx,%esi
  802596:	72 0a                	jb     8025a2 <__udivdi3+0x6a>
  802598:	3b 44 24 08          	cmp    0x8(%esp),%eax
  80259c:	0f 87 9e 00 00 00    	ja     802640 <__udivdi3+0x108>
  ...
  8025d2:	5d                   	pop    %ebp
  8025d3:	c3                   	ret    
  8025d4:	bd 20 00 00 00       	mov    $0x20,%ebp
  8025d9:	89 eb                	mov    %ebp,%ebx
  8025db:	29 fb                	sub    %edi,%ebx
  8025dd:	89 f9                	mov    %edi,%ecx
  8025df:	d3 e6                	shl    %cl,%esi
  8025e1:	89 c5                	mov    %eax,%ebp
  8025e3:	88 d9                	mov    %bl,%cl
  8025e5:	d3 ed                	shr    %cl,%ebp
  8025e7:	89 e9                	mov    %ebp,%ecx
  8025e9:	09 f1                	or     %esi,%ecx
  8025eb:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  8025ef:	89 f9                	mov    %edi,%ecx
  8025f1:	d3 e0                	shl    %cl,%eax
  8025f3:	89 c5                	mov    %eax,%ebp
  8025f5:	89 d6                	mov    %edx,%esi
  8025f7:	88 d9                	mov    %bl,%cl
  8025f9:	d3 ee                	shr    %cl,%esi
  8025fb:	89 f9                	mov    %edi,%ecx
  8025fd:	d3 e2                	shl    %cl,%edx
  8025ff:	8b 44 24 08          	mov    0x8(%esp),%eax
  802603:	88 d9                	mov    %bl,%cl
  802605:	d3 e8                	shr    %cl,%eax
  802607:	09 c2                	or     %eax,%edx
  802609:	89 d0                	mov    %edx,%eax
  80260b:	89 f2                	mov    %esi,%edx
  80260d:	f7 74 24 0c          	divl   0xc(%esp)
  802611:	89 d6                	mov    %edx,%esi
  802613:	89 c3                	mov    %eax,%ebx
  802615:	f7 e5                	mul    %ebp
  802617:	39 d6                	cmp    %edx,%esi
  802619:	72 19                	jb     802634 <__udivdi3+0xfc>
  80261b:	74 0b                	je     802628 <__udivdi3+0xf0>
  80261d:	89 d8                	mov    %ebx,%eax
  80261f:	31 ff                	xor    %edi,%edi
  802621:	e9 58 ff ff ff       	jmp    80257e <__udivdi3+0x46>
  802626:	66 90                	xchg   %ax,%ax
  802628:	8b 54 24 08          	mov    0x8(%esp),%edx
  80262c:	89 f9                	mov    %edi,%ecx
  80262e:	d3 e2                	shl    %cl,%edx
  802630:	39 c2                	cmp    %eax,%edx
  802632:	73 e9                	jae    80261d <__udivdi3+0xe5>
  802634:	8d 43 ff             	lea    -0x1(%ebx),%eax
  802637:	31 ff                	xor    %edi,%edi
  802639:	e9 40 ff ff ff       	jmp    80257e <__udivdi3+0x46>
  80263e:	66 90                	xchg   %ax,%ax
  802640:	31 c0                	xor    %eax,%eax
  802642:	e9 37 ff ff ff       	jmp    80257e <__udivdi3+0x46>
  802647:	90                   	nop
...
00802648 <__umoddi3>:
  ...
  80264f:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  802653:	8b 74 24 34          	mov    0x34(%esp),%esi
  802657:	8b 7c 24 38          	mov    0x38(%esp),%edi
  80265b:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  80265f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  802663:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  802667:	89 f3                	mov    %esi,%ebx
  802669:	89 fa                	mov    %edi,%edx
  80266b:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  80266f:	89 34 24             	mov    %esi,(%esp)
  802672:	85 c0                	test   %eax,%eax
  802674:	75 1a                	jne    802690 <__umoddi3+0x48>
  802676:	39 f7                	cmp    %esi,%edi
  802678:	0f 86 a2 00 00 00    	jbe    802720 <__umoddi3+0xd8>
  ...
  80268e:	5d                   	pop    %ebp
  80268f:	c3                   	ret    
  802690:	39 f0                	cmp    %esi,%eax
  802692:	0f 87 ac 00 00 00    	ja     802744 <__umoddi3+0xfc>
  802698:	0f bd e8             	bsr    %eax,%ebp
  80269b:	83 f5 1f             	xor    $0x1f,%ebp
  80269e:	0f 84 ac 00 00 00    	je     802750 <__umoddi3+0x108>
  8026a4:	bf 20 00 00 00       	mov    $0x20,%edi
  8026a9:	29 ef                	sub    %ebp,%edi
  8026ab:	89 fe                	mov    %edi,%esi
  8026ad:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8026b1:	89 e9                	mov    %ebp,%ecx
  8026b3:	d3 e0                	shl    %cl,%eax
  8026b5:	89 d7                	mov    %edx,%edi
  8026b7:	89 f1                	mov    %esi,%ecx
  8026b9:	d3 ef                	shr    %cl,%edi
  8026bb:	09 c7                	or     %eax,%edi
  8026bd:	89 e9                	mov    %ebp,%ecx
  8026bf:	d3 e2                	shl    %cl,%edx
  8026c1:	89 14 24             	mov    %edx,(%esp)
  8026c4:	89 d8                	mov    %ebx,%eax
  8026c6:	d3 e0                	shl    %cl,%eax
  8026c8:	89 c2                	mov    %eax,%edx
  8026ca:	8b 44 24 08          	mov    0x8(%esp),%eax
  8026ce:	d3 e0                	shl    %cl,%eax
  8026d0:	89 44 24 04          	mov    %eax,0x4(%esp)
  8026d4:	8b 44 24 08          	mov    0x8(%esp),%eax
  8026d8:	89 f1                	mov    %esi,%ecx
  8026da:	d3 e8                	shr    %cl,%eax
  8026dc:	09 d0                	or     %edx,%eax
  8026de:	d3 eb                	shr    %cl,%ebx
  8026e0:	89 da                	mov    %ebx,%edx
  8026e2:	f7 f7                	div    %edi
  8026e4:	89 d3                	mov    %edx,%ebx
  8026e6:	f7 24 24             	mull   (%esp)
  8026e9:	89 c6                	mov    %eax,%esi
  8026eb:	89 d1                	mov    %edx,%ecx
  8026ed:	39 d3                	cmp    %edx,%ebx
  8026ef:	0f 82 87 00 00 00    	jb     80277c <__umoddi3+0x134>
  8026f5:	0f 84 91 00 00 00    	je     80278c <__umoddi3+0x144>
  8026fb:	8b 54 24 04          	mov    0x4(%esp),%edx
  8026ff:	29 f2                	sub    %esi,%edx
  802701:	19 cb                	sbb    %ecx,%ebx
  802703:	89 d8                	mov    %ebx,%eax
  802705:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  ...
  802724:	75 0b                	jne    802731 <__umoddi3+0xe9>
  ...
  80273d:	e9 44 ff ff ff       	jmp    802686 <__umoddi3+0x3e>
  802742:	66 90                	xchg   %ax,%ax
  802744:	89 c8                	mov    %ecx,%eax
  802746:	89 f2                	mov    %esi,%edx
  ...
  80274e:	5d                   	pop    %ebp
  80274f:	c3                   	ret    
  802750:	3b 04 24             	cmp    (%esp),%eax
  802753:	72 06                	jb     80275b <__umoddi3+0x113>
  802755:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802759:	77 0f                	ja     80276a <__umoddi3+0x122>
  80275b:	89 f2                	mov    %esi,%edx
  80275d:	29 f9                	sub    %edi,%ecx
  80275f:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  802763:	89 14 24             	mov    %edx,(%esp)
  802766:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  80276a:	8b 44 24 04          	mov    0x4(%esp),%eax
  80276e:	8b 14 24             	mov    (%esp),%edx
  ...
  80277c:	2b 04 24             	sub    (%esp),%eax
  80277f:	19 fa                	sbb    %edi,%edx
  802781:	89 d1                	mov    %edx,%ecx
  802783:	89 c6                	mov    %eax,%esi
  802785:	e9 71 ff ff ff       	jmp    8026fb <__umoddi3+0xb3>
  80278a:	66 90                	xchg   %ax,%ax
  80278c:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802790:	72 ea                	jb     80277c <__umoddi3+0x134>
  802792:	89 d9                	mov    %ebx,%ecx
  802794:	e9 62 ff ff ff       	jmp    8026fb <__umoddi3+0xb3>
