...
void _main(void)
{
  ...
  8000b3:	68 af 27 80 00       	push   $0x8027af
  ...
  800118:	68 03 28 80 00       	push   $0x802803
  ...
  800158:	e8 8a 1f 00 00       	call   8020e7 <sys_enable_interrupt>
  ...
  8001ca:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001cd:	e8 fb 1e 00 00       	call   8020cd <sys_disable_interrupt>
		cprintf("Sorting is Finished!!!!it'll be checked now....\n") ;
  8001d2:	83 ec 0c             	sub    $0xc,%esp
  8001d5:	68 0c 28 80 00       	push   $0x80280c
  8001da:	e8 bf 09 00 00       	call   800b9e <cprintf>
  8001df:	83 c4 10             	add    $0x10,%esp
		//PrintElements(Elements, NumOfElements);
		sys_enable_interrupt();
  8001e2:	e8 00 1f 00 00       	call   8020e7 <sys_enable_interrupt>
  ...
  800204:	68 40 28 80 00       	push   $0x802840
  800209:	6a 4e                	push   $0x4e
  80020b:	68 62 28 80 00       	push   $0x802862
  800210:	e8 e7 06 00 00       	call   8008fc <_panic>
		else
		{
			sys_disable_interrupt();
  800215:	e8 b3 1e 00 00       	call   8020cd <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  80021a:	83 ec 0c             	sub    $0xc,%esp
  80021d:	68 80 28 80 00       	push   $0x802880
  800222:	e8 77 09 00 00       	call   800b9e <cprintf>
  800227:	83 c4 10             	add    $0x10,%esp
			cprintf("Congratulations!! The array is sorted correctly\n") ;
  80022a:	83 ec 0c             	sub    $0xc,%esp
  80022d:	68 b4 28 80 00       	push   $0x8028b4
  800232:	e8 67 09 00 00       	call   800b9e <cprintf>
  800237:	83 c4 10             	add    $0x10,%esp
			cprintf("===============================================\n\n") ;
  80023a:	83 ec 0c             	sub    $0xc,%esp
  80023d:	68 e8 28 80 00       	push   $0x8028e8
  800242:	e8 57 09 00 00       	call   800b9e <cprintf>
  800247:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  80024a:	e8 98 1e 00 00       	call   8020e7 <sys_enable_interrupt>
		}

		free(Elements) ;
  80024f:	83 ec 0c             	sub    $0xc,%esp
  800252:	ff 75 ec             	pushl  -0x14(%ebp)
  800255:	e8 fd 18 00 00       	call   801b57 <free>
  80025a:	83 c4 10             	add    $0x10,%esp

		sys_disable_interrupt();
  80025d:	e8 6b 1e 00 00       	call   8020cd <sys_disable_interrupt>
			Chose = 0 ;
  ...
  80026b:	68 1a 29 80 00       	push   $0x80291a
  ...
  8002b0:	75 b6                	jne    800268 <_main+0x230>
		...
		sys_enable_interrupt();
  8002b2:	e8 30 1e 00 00       	call   8020e7 <sys_enable_interrupt>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800467:	50                   	push   %eax
  800468:	68 38 29 80 00       	push   $0x802938
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800495:	50                   	push   %eax
  800496:	68 af 27 80 00       	push   $0x8027af
...
void Merge(int* A, int p, int q, int r)
{
  ...
  8006fe:	e8 54 14 00 00       	call   801b57 <free>
  800703:	83 c4 10             	add    $0x10,%esp
	free(Right);
  800706:	83 ec 0c             	sub    $0xc,%esp
  800709:	ff 75 d4             	pushl  -0x2c(%ebp)
  80070c:	e8 46 14 00 00       	call   801b57 <free>
...
cputchar(int ch)
{
  ...
  80072a:	50                   	push   %eax
  80072b:	e8 d1 19 00 00       	call   802101 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  800739:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80073c:	e8 8c 19 00 00       	call   8020cd <sys_disable_interrupt>
	char c = ch;
  ...
  80074e:	50                   	push   %eax
  80074f:	e8 ad 19 00 00       	call   802101 <sys_cputc>
  800754:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800757:	e8 8b 19 00 00       	call   8020e7 <sys_enable_interrupt>
}
  80075c:	90                   	nop
  80075d:	c9                   	leave  
  80075e:	c3                   	ret    
...
getchar(void)
{
  ...
  80076c:	eb 08                	jmp    800776 <getchar+0x17>
	{
		c = sys_cgetc();
  80076e:	e8 72 17 00 00       	call   801ee5 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800784:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800787:	e8 41 19 00 00       	call   8020cd <sys_disable_interrupt>
	int c=0;
  ...
  800793:	eb 08                	jmp    80079d <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800795:	e8 4b 17 00 00       	call   801ee5 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8007a1:	74 f2                	je     800795 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  8007a3:	e8 3f 19 00 00       	call   8020e7 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007bd:	e8 70 17 00 00       	call   801f32 <sys_getenvindex>
  ...
  800837:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80083a:	e8 8e 18 00 00       	call   8020cd <sys_disable_interrupt>
	cprintf("**************************************\n");
  80083f:	83 ec 0c             	sub    $0xc,%esp
  800842:	68 58 29 80 00       	push   $0x802958
  ...
  800868:	52                   	push   %edx
  800869:	50                   	push   %eax
  80086a:	68 80 29 80 00       	push   $0x802980
  ...
  800890:	52                   	push   %edx
  800891:	50                   	push   %eax
  800892:	68 a8 29 80 00       	push   $0x8029a8
  ...
  8008ad:	50                   	push   %eax
  8008ae:	68 e9 29 80 00       	push   $0x8029e9
  8008b3:	e8 e6 02 00 00       	call   800b9e <cprintf>
  8008b8:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8008bb:	83 ec 0c             	sub    $0xc,%esp
  8008be:	68 58 29 80 00       	push   $0x802958
  8008c3:	e8 d6 02 00 00       	call   800b9e <cprintf>
  8008c8:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8008cb:	e8 17 18 00 00       	call   8020e7 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8008e3:	e8 16 16 00 00       	call   801efe <sys_env_destroy>
...
exit(void)
{
  ...
  8008f1:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8008f4:	e8 6b 16 00 00       	call   801f64 <sys_env_exit>
}
  8008f9:	90                   	nop
  8008fa:	c9                   	leave  
  8008fb:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80091c:	50                   	push   %eax
  80091d:	68 00 2a 80 00       	push   $0x802a00
  ...
  800935:	50                   	push   %eax
  800936:	68 05 2a 80 00       	push   $0x802a05
  ...
  80095a:	68 21 2a 80 00       	push   $0x802a21
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800986:	68 24 2a 80 00       	push   $0x802a24
  80098b:	6a 26                	push   $0x26
  80098d:	68 70 2a 80 00       	push   $0x802a70
  ...
  800a4c:	68 7c 2a 80 00       	push   $0x802a7c
  800a51:	6a 3a                	push   $0x3a
  800a53:	68 70 2a 80 00       	push   $0x802a70
  ...
  800ab6:	68 d0 2a 80 00       	push   $0x802ad0
  800abb:	6a 44                	push   $0x44
  800abd:	68 70 2a 80 00       	push   $0x802a70
...
static void putch(int ch, struct printbuf *b) {
  ...
  800b0e:	51                   	push   %ecx
  800b0f:	52                   	push   %edx
  800b10:	e8 a7 13 00 00       	call   801ebc <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800b86:	50                   	push   %eax
  800b87:	e8 30 13 00 00       	call   801ebc <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bce:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bd1:	e8 f7 14 00 00       	call   8020cd <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800bee:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800bf1:	e8 f1 14 00 00       	call   8020e7 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800c3b:	e8 b0 18 00 00       	call   8024f0 <__udivdi3>
  ...
  800c89:	52                   	push   %edx
  800c8a:	50                   	push   %eax
  800c8b:	e8 70 19 00 00       	call   802600 <__umoddi3>
  800c90:	83 c4 10             	add    $0x10,%esp
  800c93:	05 34 2d 80 00       	add    $0x802d34,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800de6:	8b 04 85 58 2d 80 00 	mov    0x802d58(,%eax,4),%eax
  ...
  800ec7:	8b 34 9d a0 2b 80 00 	mov    0x802ba0(,%ebx,4),%esi
  800ece:	85 f6                	test   %esi,%esi
  800ed0:	75 19                	jne    800eeb <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ed2:	53                   	push   %ebx
  800ed3:	68 45 2d 80 00       	push   $0x802d45
  ...
  800ee6:	e9 49 02 00 00       	jmp    801134 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800eeb:	56                   	push   %esi
  800eec:	68 4e 2d 80 00       	push   $0x802d4e
  ...
  800f17:	75 05                	jne    800f1e <vprintfmt+0x1a6>
				p = "(null)";
  800f19:	be 51 2d 80 00       	mov    $0x802d51,%esi
			if (width > 0 && padc != '-')
...
void* malloc(uint32 size)
{
  ...
  80192b:	83 ec 28             	sub    $0x28,%esp
	...
	if(arraySize == 0)
  80192e:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801933:	85 c0                	test   %eax,%eax
  801935:	75 33                	jne    80196a <malloc+0x42>
	{
		spaces[0].str_address = (void*)USER_HEAP_START;
  801937:	c7 05 20 31 80 00 00 	movl   $0x80000000,0x803120
  80193e:	00 00 80 
		spaces[0].end_address = (void*)USER_HEAP_MAX;
  801941:	c7 05 24 31 80 00 00 	movl   $0xa0000000,0x803124
  801948:	00 00 a0 
		spaces[0].pages = numPages;
  80194b:	c7 05 28 31 80 00 00 	movl   $0x20000,0x803128
  801952:	00 02 00 
		spaces[0].isFree = 1;
  801955:	c7 05 2c 31 80 00 01 	movl   $0x1,0x80312c
  80195c:	00 00 00 
		arraySize++;
  80195f:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801964:	40                   	inc    %eax
  801965:	a3 2c 30 80 00       	mov    %eax,0x80302c
	}
	int min_diff = numPages + 1;
  80196a:	c7 45 f4 01 00 02 00 	movl   $0x20001,-0xc(%ebp)
	int index = -1;
  801971:	c7 45 f0 ff ff ff ff 	movl   $0xffffffff,-0x10(%ebp)
	size = ROUNDUP(size,PAGE_SIZE);
  801978:	c7 45 e8 00 10 00 00 	movl   $0x1000,-0x18(%ebp)
  ...
  801993:	f7 75 e8             	divl   -0x18(%ebp)
  801996:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801999:	29 d0                	sub    %edx,%eax
  80199b:	89 45 08             	mov    %eax,0x8(%ebp)
  ...
  8019ae:	eb 57                	jmp    801a07 <malloc+0xdf>
	{
		if(spaces[i].isFree == 0) continue;
  8019b0:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019b3:	c1 e0 04             	shl    $0x4,%eax
  8019b6:	05 2c 31 80 00       	add    $0x80312c,%eax
  8019bb:	8b 00                	mov    (%eax),%eax
  8019bd:	85 c0                	test   %eax,%eax
  8019bf:	74 42                	je     801a03 <malloc+0xdb>

		if(spaces[i].pages >= reqPages)
  8019c1:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019c4:	c1 e0 04             	shl    $0x4,%eax
  8019c7:	05 28 31 80 00       	add    $0x803128,%eax
  8019cc:	8b 00                	mov    (%eax),%eax
  8019ce:	3b 45 e0             	cmp    -0x20(%ebp),%eax
  8019d1:	7c 31                	jl     801a04 <malloc+0xdc>
		{
			if(min_diff > spaces[i].pages - reqPages)
  8019d3:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019d6:	c1 e0 04             	shl    $0x4,%eax
  8019d9:	05 28 31 80 00       	add    $0x803128,%eax
  8019de:	8b 00                	mov    (%eax),%eax
  8019e0:	2b 45 e0             	sub    -0x20(%ebp),%eax
  8019e3:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  8019e6:	7d 1c                	jge    801a04 <malloc+0xdc>
			{
				min_diff = spaces[i].pages - reqPages;
  8019e8:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019eb:	c1 e0 04             	shl    $0x4,%eax
  8019ee:	05 28 31 80 00       	add    $0x803128,%eax
  8019f3:	8b 00                	mov    (%eax),%eax
  8019f5:	2b 45 e0             	sub    -0x20(%ebp),%eax
  8019f8:	89 45 f4             	mov    %eax,-0xc(%ebp)
				index = i;
  8019fb:	8b 45 ec             	mov    -0x14(%ebp),%eax
  8019fe:	89 45 f0             	mov    %eax,-0x10(%ebp)
  801a01:	eb 01                	jmp    801a04 <malloc+0xdc>
	size = ROUNDUP(size,PAGE_SIZE);
	int reqPages = size/PAGE_SIZE;
  ...
  801a03:	90                   	nop
	...
	for(int i = 0 ; i < arraySize ; i++)
  801a04:	ff 45 ec             	incl   -0x14(%ebp)
  801a07:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801a0c:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801a0f:	7c 9f                	jl     8019b0 <malloc+0x88>
			}
		}
	...
	if(index == -1 )
  801a11:	83 7d f0 ff          	cmpl   $0xffffffff,-0x10(%ebp)
  801a15:	75 0a                	jne    801a21 <malloc+0xf9>
	{
		return NULL;
  801a17:	b8 00 00 00 00       	mov    $0x0,%eax
  801a1c:	e9 34 01 00 00       	jmp    801b55 <malloc+0x22d>
	}
  ...
  801a71:	05 20 31 80 00       	add    $0x803120,%eax
  ...
  801a83:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801a88:	c1 e0 04             	shl    $0x4,%eax
  801a8b:	8d 90 20 31 80 00    	lea    0x803120(%eax),%edx
  801a91:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801a94:	89 02                	mov    %eax,(%edx)
			spaces[arraySize].end_address = spaces[index].end_address;
  801a96:	8b 15 2c 30 80 00    	mov    0x80302c,%edx
  801a9c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a9f:	c1 e0 04             	shl    $0x4,%eax
  801aa2:	05 24 31 80 00       	add    $0x803124,%eax
  801aa7:	8b 00                	mov    (%eax),%eax
  801aa9:	c1 e2 04             	shl    $0x4,%edx
  801aac:	81 c2 24 31 80 00    	add    $0x803124,%edx
  801ab2:	89 02                	mov    %eax,(%edx)
			spaces[arraySize].pages = spaces[index].pages-reqPages;
  801ab4:	8b 15 2c 30 80 00    	mov    0x80302c,%edx
  ...
  801ac7:	2b 45 e0             	sub    -0x20(%ebp),%eax
  801aca:	c1 e2 04             	shl    $0x4,%edx
  801acd:	81 c2 28 31 80 00    	add    $0x803128,%edx
  ...
  801ae2:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
			arraySize++;
  801ae8:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801aed:	40                   	inc    %eax
  801aee:	a3 2c 30 80 00       	mov    %eax,0x80302c

			//modify space to represent allocated part
			spaces[index].end_address = newEnd;
  801af3:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801af6:	c1 e0 04             	shl    $0x4,%eax
  801af9:	8d 90 24 31 80 00    	lea    0x803124(%eax),%edx
  801aff:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b02:	89 02                	mov    %eax,(%edx)
			spaces[index].pages = reqPages;
  801b04:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b07:	c1 e0 04             	shl    $0x4,%eax
  801b0a:	8d 90 28 31 80 00    	lea    0x803128(%eax),%edx
  801b10:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801b13:	89 02                	mov    %eax,(%edx)
			spaces[index].isFree = 0;
  801b15:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b18:	c1 e0 04             	shl    $0x4,%eax
  801b1b:	05 2c 31 80 00       	add    $0x80312c,%eax
  801b20:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			sys_allocateMem((uint32)spaces[index].str_address, reqPages*PAGE_SIZE);
  801b26:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801b29:	c1 e0 0c             	shl    $0xc,%eax
  ...
  801b3e:	52                   	push   %edx
  801b3f:	50                   	push   %eax
  801b40:	e8 1f 05 00 00       	call   802064 <sys_allocateMem>
  801b45:	83 c4 10             	add    $0x10,%esp
		}
		return spaces[index].str_address;
  801b48:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b4b:	c1 e0 04             	shl    $0x4,%eax
...
void free(void* virtual_address)
{
  ...
  801b5a:	83 ec 28             	sub    $0x28,%esp
	//TODO: [PROJECT 2021 - [2] User Heap] free() [User Side]
	// Write your code here, remove the panic and write your code

	int index = -1 ;
  801b5d:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
	int noMerge = 1;
  801b64:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
	for(int i = 0 ; i < arraySize ; i++)
  801b6b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801b72:	eb 3f                	jmp    801bb3 <free+0x5c>
	{
		if(spaces[i].str_address == virtual_address)
  801b74:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b77:	c1 e0 04             	shl    $0x4,%eax
  801b7a:	05 20 31 80 00       	add    $0x803120,%eax
  801b7f:	8b 00                	mov    (%eax),%eax
  801b81:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b84:	75 2a                	jne    801bb0 <free+0x59>
		{
			index=i;
  801b86:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b89:	89 45 f4             	mov    %eax,-0xc(%ebp)
			sys_freeMem((uint32)virtual_address,spaces[i].pages*PAGE_SIZE);
  801b8c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801b8f:	c1 e0 04             	shl    $0x4,%eax
  801b92:	05 28 31 80 00       	add    $0x803128,%eax
  ...
  801ba4:	52                   	push   %edx
  801ba5:	50                   	push   %eax
  801ba6:	e8 9d 04 00 00       	call   802048 <sys_freeMem>
  801bab:	83 c4 10             	add    $0x10,%esp
			break;
  801bae:	eb 0d                	jmp    801bbd <free+0x66>
	//TODO: [PROJECT 2021 - [2] User Heap] free() [User Side]
	// Write your code here, remove the panic and write your code
	...
	int noMerge = 1;
	for(int i = 0 ; i < arraySize ; i++)
  801bb0:	ff 45 ec             	incl   -0x14(%ebp)
  801bb3:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801bb8:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801bbb:	7c b7                	jl     801b74 <free+0x1d>
			break;
		}
	...
	if(index == -1)
  801bbd:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
  801bc1:	75 17                	jne    801bda <free+0x83>
	{
		panic("Error");
  801bc3:	83 ec 04             	sub    $0x4,%esp
  801bc6:	68 b0 2e 80 00       	push   $0x802eb0
  801bcb:	68 81 00 00 00       	push   $0x81
  801bd0:	68 b6 2e 80 00       	push   $0x802eb6
  801bd5:	e8 22 ed ff ff       	call   8008fc <_panic>
	}

	for(int i = 0 ; i < arraySize ; i++)
  801bda:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801be1:	e9 cc 00 00 00       	jmp    801cb2 <free+0x15b>
	{
		if(spaces[i].isFree == 0) continue;
  801be6:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801be9:	c1 e0 04             	shl    $0x4,%eax
  801bec:	05 2c 31 80 00       	add    $0x80312c,%eax
  801bf1:	8b 00                	mov    (%eax),%eax
  801bf3:	85 c0                	test   %eax,%eax
  801bf5:	0f 84 b3 00 00 00    	je     801cae <free+0x157>

		if(spaces[index].str_address == spaces[i].end_address)
  801bfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801bfe:	c1 e0 04             	shl    $0x4,%eax
  801c01:	05 20 31 80 00       	add    $0x803120,%eax
  801c06:	8b 10                	mov    (%eax),%edx
  801c08:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c0b:	c1 e0 04             	shl    $0x4,%eax
  801c0e:	05 24 31 80 00       	add    $0x803124,%eax
  801c13:	8b 00                	mov    (%eax),%eax
  801c15:	39 c2                	cmp    %eax,%edx
  801c17:	0f 85 92 00 00 00    	jne    801caf <free+0x158>
		{
			//merge
  ...
  801cb7:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  801cba:	0f 8c 26 ff ff ff    	jl     801be6 <free+0x8f>
			noMerge = 0;
			break;
		}
	}
	...
	for(int i = 0 ; i < arraySize ; i++)
  801cc0:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
  801cc7:	e9 cc 00 00 00       	jmp    801d98 <free+0x241>
	{
		if(spaces[i].isFree == 0) continue;
  801ccc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801ccf:	c1 e0 04             	shl    $0x4,%eax
  801cd2:	05 2c 31 80 00       	add    $0x80312c,%eax
  801cd7:	8b 00                	mov    (%eax),%eax
  801cd9:	85 c0                	test   %eax,%eax
  801cdb:	0f 84 b3 00 00 00    	je     801d94 <free+0x23d>

		if(spaces[index].end_address == spaces[i].str_address)
  801ce1:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ce4:	c1 e0 04             	shl    $0x4,%eax
  801ce7:	05 24 31 80 00       	add    $0x803124,%eax
  801cec:	8b 10                	mov    (%eax),%edx
  801cee:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801cf1:	c1 e0 04             	shl    $0x4,%eax
  801cf4:	05 20 31 80 00       	add    $0x803120,%eax
  801cf9:	8b 00                	mov    (%eax),%eax
  801cfb:	39 c2                	cmp    %eax,%edx
  801cfd:	0f 85 92 00 00 00    	jne    801d95 <free+0x23e>
		{
			//merge
  ...
  801d13:	c1 e2 04             	shl    $0x4,%edx
  801d16:	81 c2 20 31 80 00    	add    $0x803120,%edx
  801d1c:	89 02                	mov    %eax,(%edx)
			spaces[i].pages += spaces[index].pages;
  801d1e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d21:	c1 e0 04             	shl    $0x4,%eax
  801d24:	05 28 31 80 00       	add    $0x803128,%eax
  801d29:	8b 10                	mov    (%eax),%edx
  801d2b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d2e:	c1 e0 04             	shl    $0x4,%eax
  801d31:	05 28 31 80 00       	add    $0x803128,%eax
  801d36:	8b 00                	mov    (%eax),%eax
  801d38:	01 c2                	add    %eax,%edx
  801d3a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801d3d:	c1 e0 04             	shl    $0x4,%eax
  801d40:	05 28 31 80 00       	add    $0x803128,%eax
  801d45:	89 10                	mov    %edx,(%eax)

			//remove from spaces
			spaces[index].str_address = 0;
  801d47:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d4a:	c1 e0 04             	shl    $0x4,%eax
  801d4d:	05 20 31 80 00       	add    $0x803120,%eax
  801d52:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].end_address = 0;
  801d58:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d5b:	c1 e0 04             	shl    $0x4,%eax
  801d5e:	05 24 31 80 00       	add    $0x803124,%eax
  801d63:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			spaces[index].pages = -1;
  801d69:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d6c:	c1 e0 04             	shl    $0x4,%eax
  801d6f:	05 28 31 80 00       	add    $0x803128,%eax
  801d74:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%eax)
			spaces[index].isFree = 0;
  801d7a:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801d7d:	c1 e0 04             	shl    $0x4,%eax
  801d80:	05 2c 31 80 00       	add    $0x80312c,%eax
  801d85:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			noMerge = 0;
  801d8b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
			break;
  801d92:	eb 12                	jmp    801da6 <free+0x24f>
		}
	}
  ...
  801d94:	90                   	nop
	...
	for(int i = 0 ; i < arraySize ; i++)
  801d95:	ff 45 e4             	incl   -0x1c(%ebp)
  801d98:	a1 2c 30 80 00       	mov    0x80302c,%eax
  801d9d:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801da0:	0f 8c 26 ff ff ff    	jl     801ccc <free+0x175>
			noMerge = 0;
			break;
		}
	}
	...
	if(noMerge == 1)
  801da6:	83 7d f0 01          	cmpl   $0x1,-0x10(%ebp)
  801daa:	75 11                	jne    801dbd <free+0x266>
	{
		spaces[index].isFree = 1;
  801dac:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801daf:	c1 e0 04             	shl    $0x4,%eax
  801db2:	05 2c 31 80 00       	add    $0x80312c,%eax
  801db7:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
	}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801dc9:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801dcc:	83 ec 04             	sub    $0x4,%esp
  801dcf:	68 c4 2e 80 00       	push   $0x802ec4
  801dd4:	68 b9 00 00 00       	push   $0xb9
  801dd9:	68 b6 2e 80 00       	push   $0x802eb6
  801dde:	e8 19 eb ff ff       	call   8008fc <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801dec:	68 c4 2e 80 00       	push   $0x802ec4
  801df1:	68 bf 00 00 00       	push   $0xbf
  801df6:	68 b6 2e 80 00       	push   $0x802eb6
  801dfb:	e8 fc ea ff ff       	call   8008fc <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801e09:	68 c4 2e 80 00       	push   $0x802ec4
  801e0e:	68 c5 00 00 00       	push   $0xc5
  801e13:	68 b6 2e 80 00       	push   $0x802eb6
  801e18:	e8 df ea ff ff       	call   8008fc <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801e26:	68 c4 2e 80 00       	push   $0x802ec4
  801e2b:	68 ca 00 00 00       	push   $0xca
  801e30:	68 b6 2e 80 00       	push   $0x802eb6
  801e35:	e8 c2 ea ff ff       	call   8008fc <_panic>
...
void expand(uint32 newSize)
{
  ...
  801e43:	68 c4 2e 80 00       	push   $0x802ec4
  801e48:	68 d0 00 00 00       	push   $0xd0
  801e4d:	68 b6 2e 80 00       	push   $0x802eb6
  801e52:	e8 a5 ea ff ff       	call   8008fc <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801e60:	68 c4 2e 80 00       	push   $0x802ec4
  801e65:	68 d4 00 00 00       	push   $0xd4
  801e6a:	68 b6 2e 80 00       	push   $0x802eb6
  801e6f:	e8 88 ea ff ff       	call   8008fc <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801e7d:	68 c4 2e 80 00       	push   $0x802ec4
  801e82:	68 d9 00 00 00       	push   $0xd9
  801e87:	68 b6 2e 80 00       	push   $0x802eb6
  801e8c:	e8 6b ea ff ff       	call   8008fc <_panic>
