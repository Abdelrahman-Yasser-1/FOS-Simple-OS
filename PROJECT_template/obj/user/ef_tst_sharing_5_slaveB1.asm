...
_main(void)
{
  ...
  80009f:	68 dc 21 80 00       	push   $0x8021dc
  8000a4:	50                   	push   %eax
  ...
  80011c:	68 40 22 80 00       	push   $0x802240
...
libmain(int argc, char **argv)
{
  ...
  8001c0:	68 00 23 80 00       	push   $0x802300
  ...
  8001e6:	52                   	push   %edx
  8001e7:	50                   	push   %eax
  8001e8:	68 28 23 80 00       	push   $0x802328
  ...
  80020e:	52                   	push   %edx
  80020f:	50                   	push   %eax
  800210:	68 50 23 80 00       	push   $0x802350
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  80029a:	50                   	push   %eax
  80029b:	68 a8 23 80 00       	push   $0x8023a8
  ...
  8002b3:	50                   	push   %eax
  8002b4:	68 ad 23 80 00       	push   $0x8023ad
  ...
  8002d8:	68 c9 23 80 00       	push   $0x8023c9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800304:	68 cc 23 80 00       	push   $0x8023cc
  800309:	6a 26                	push   $0x26
  80030b:	68 18 24 80 00       	push   $0x802418
  ...
  8003ca:	68 24 24 80 00       	push   $0x802424
  8003cf:	6a 3a                	push   $0x3a
  8003d1:	68 18 24 80 00       	push   $0x802418
  ...
  800434:	68 78 24 80 00       	push   $0x802478
  800439:	6a 44                	push   $0x44
  80043b:	68 18 24 80 00       	push   $0x802418
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800611:	05 f4 26 80 00       	add    $0x8026f4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800764:	8b 04 85 18 27 80 00 	mov    0x802718(,%eax,4),%eax
  ...
  800845:	8b 34 9d 60 25 80 00 	mov    0x802560(,%ebx,4),%esi
  80084c:	85 f6                	test   %esi,%esi
  80084e:	75 19                	jne    800869 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800850:	53                   	push   %ebx
  800851:	68 05 27 80 00       	push   $0x802705
  ...
  800864:	e9 49 02 00 00       	jmp    800ab2 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800869:	56                   	push   %esi
  80086a:	68 0e 27 80 00       	push   $0x80270e
  ...
  800895:	75 05                	jne    80089c <vprintfmt+0x1a6>
				p = "(null)";
  800897:	be 11 27 80 00       	mov    $0x802711,%esi
			if (width > 0 && padc != '-')
...
void free(void* virtual_address)
{
  ...
  801544:	68 70 28 80 00       	push   $0x802870
  801549:	68 81 00 00 00       	push   $0x81
  80154e:	68 76 28 80 00       	push   $0x802876
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80174d:	68 84 28 80 00       	push   $0x802884
  801752:	68 b9 00 00 00       	push   $0xb9
  801757:	68 76 28 80 00       	push   $0x802876
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80176a:	68 84 28 80 00       	push   $0x802884
  80176f:	68 bf 00 00 00       	push   $0xbf
  801774:	68 76 28 80 00       	push   $0x802876
...
void sfree(void* virtual_address)
{
  ...
  801787:	68 84 28 80 00       	push   $0x802884
  80178c:	68 c5 00 00 00       	push   $0xc5
  801791:	68 76 28 80 00       	push   $0x802876
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8017a4:	68 84 28 80 00       	push   $0x802884
  8017a9:	68 ca 00 00 00       	push   $0xca
  8017ae:	68 76 28 80 00       	push   $0x802876
...
void expand(uint32 newSize)
{
  ...
  8017c1:	68 84 28 80 00       	push   $0x802884
  8017c6:	68 d0 00 00 00       	push   $0xd0
  8017cb:	68 76 28 80 00       	push   $0x802876
...
void shrink(uint32 newSize)
{
  ...
  8017de:	68 84 28 80 00       	push   $0x802884
  8017e3:	68 d4 00 00 00       	push   $0xd4
  8017e8:	68 76 28 80 00       	push   $0x802876
...
void freeHeap(void* virtual_address)
{
  ...
  8017fb:	68 84 28 80 00       	push   $0x802884
  801800:	68 d9 00 00 00       	push   $0xd9
  801805:	68 76 28 80 00       	push   $0x802876
